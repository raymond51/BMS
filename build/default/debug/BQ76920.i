...
void init_AFE(void) {
    ...
    setShortCircuitProtection(40000, 200);
# 20 "BQ76920.c"
}
...
void setShortCircuitProtection(long current_mA, int delay_us) {
    ...
    protect1.bits.SCD_THRESH = 0;
        ...
        for (int i = 0; i < 8; i++) {
            int value = (current_mA * shuntResistorValue_mOhm * scaler) / 1000;
            if ( value >= SCD_threshold_setting[i]) {
...
# 128 "BQ76920.c"
    long AFE_getSetShortCircuitCurrent() {
        return (long) SCD_threshold_setting[protect1.bits.SCD_THRESH];
    }
